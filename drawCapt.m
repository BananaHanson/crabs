...
captainGraphics(13) = drawLine(pt15 , pt19 , "k");
captainGraphics(14) = drawLine(pt15 , pt16 , "k");
captainGraphics(15) = drawLine(pt19 , pt18 , "k");
captainGraphics(16) = drawLine(pt13 , pt20 , "k");
captainGraphics(17) = drawLine(pt17 , pt20 , "k");
endfunction
