...
%trident
captPt15=[ 3*captSize; -3*captSize; 1];
captPt16=[ 5*captSize; -3*captSize; 1];
captPt17=[ 5*captSize; -2*captSize; 1];
captPt18=[ 5*captSize; -1*captSize; 1];
...
captPt16, captPt17, captPt18, captPt19, captPt20];
endfunction
